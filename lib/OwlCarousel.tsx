...
export type OwlCarouselProps = CarouselOptions & ComponentProps;
...
export default class ReactOwlCarousel extends Component<OwlCarouselProps> {
    ...
    public create(options?: CarouselOptions) {
        if (!this.$ele) throw new Error('OwlCarousel is not created');
...
function filterOptions(item: Params): [CarouselOptions, ComponentProps] {
    ...
    return [options as CarouselOptions, propsWithoutOptions as ComponentProps];
}
