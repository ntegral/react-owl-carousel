export interface CarouselOptions {
    ...
    callbacks?: boolean;
    responsive?: {
        [breakpoint: string]: CarouselOptions;
    };
...
export declare type HandlerCallback = (...args: any[]) => void;
export declare type OnEvent = 'initialize.owl.carousel' | 'initialized.owl.carousel' | 'resize.owl.carousel' | 'resized.owl.carousel' | 'refresh.owl.carousel' | 'refreshed.owl.carousel' | 'drag.owl.carousel' | 'dragged.owl.carousel' | 'translate.owl.carousel' | 'translated.owl.carousel' | 'change.owl.carousel' | 'changed.owl.carousel' | 'load.owl.lazy' | 'loaded.owl.lazy' | 'stop.owl.video' | 'play.owl.video';
export declare type TriggerEvent = 'refresh.owl.carousel' | 'next.owl.carousel' | 'prev.owl.carousel' | 'to.owl.carousel' | 'destroy.owl.carousel' | 'replace.owl.carousel' | 'add.owl.carousel' | 'remove.owl.carousel' | 'play.owl.autoplay' | 'stop.owl.autoplay';
